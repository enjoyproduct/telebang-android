 ...
 */
public class MNewsListSlideFragment extends BaseAppSlideFragment {
    public static final String TAG = MNewsListSlideFragment.class.getSimpleName();

    public static MNewsListSlideFragment newInstance() {
        MNewsListSlideFragment fragment = new MNewsListSlideFragment();
        return fragment;
    }
