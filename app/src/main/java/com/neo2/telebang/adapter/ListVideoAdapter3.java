...
public class ListVideoAdapter3 extends UltimateViewAdapter<ListVideoAdapter3.HolderListCell> {
    private List<VideoModel> mItems;
    private AdapterVideoActionListener listener;

    public ListVideoAdapter3() {
    ...
    public HolderListCell onCreateViewHolder(ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_video_list_3, parent, false);
    ...
    public void onBindViewHolder(final HolderListCell holder, final int position) {
        ...
        if (model != null) {
            ...
            holder.tvnFullName.setText(model.getAuthorName());
            ...
            holder.imvAvatar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (listener != null)
                        listener.onUserClickListener(model.getAuthor());
                }
            });

            holder.tvnFullName.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (listener != null)
                        listener.onUserClickListener(model.getAuthor());
            ...
            ImageLoader.getInstance().displayImage(model.getAuthor().avatar, holder.imvAvatar, ImageUtil.optionsImageAvatar);
        }
    }
...
//        notifyDataSetChanged();
    ...
    public class HolderListCell extends UltimateRecyclerviewViewHolder {
        ...
        @BindView(R.id.tvnFullName)
        TextView tvnFullName;
