 ...
 */
public class HomeFragment_3 extends BaseAppSlideFragment {
    public static final String TAG = HomeFragment_3.class.getSimpleName();

    public static HomeFragment_3 newInstance() {
        HomeFragment_3 fragment = new HomeFragment_3();
        return fragment;
    }
    ...
    public void onInitView() {
        TabSetting.HOME_3.setup(viewpagerTab);

        final FragmentPagerItems pages = new FragmentPagerItems(mContext);
        for (int titleResId : TabSetting.HOME_3.tabs()) {
            FragmentPagerItem fragmentPagerItem = TabSetting.HOME_3.getFragmentPagerItem(mContext, titleResId);
        ...
        updateHeaderTitle(getString(R.string.home_latest));
    }
