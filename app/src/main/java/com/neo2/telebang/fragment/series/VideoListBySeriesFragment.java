...
public class VideoListBySeriesFragment extends BaseAppSlideFragment implements AdapterVideoActionListener {
    ...
    public static VideoListBySeriesFragment newInstance(SeriesJSON seriesJSON) {
        VideoListBySeriesFragment fragment = new VideoListBySeriesFragment();
        fragment.seriesJSON = seriesJSON;
        return fragment;
    }
    ...
    public void onInitView() {
        tvnHeaderTitle.setText(seriesJSON.title);
...
//        });
    ...
    void requestGetVideos() {
        ...
        RPC.getVideosBySeries(seriesJSON.id, pageNumber, new APIResponseListener() {
            @Override
